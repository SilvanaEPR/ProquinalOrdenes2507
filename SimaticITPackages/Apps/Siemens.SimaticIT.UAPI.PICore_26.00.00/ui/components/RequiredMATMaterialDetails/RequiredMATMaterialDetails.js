(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.UAPI.PICore').component('requiredmatmaterialdetails', ComponentDefinition());
    ...
    function ComponentDefinition() {
        return {
            ...
            templateUrl: 'Siemens.SimaticIT.UAPI.PICore/components/RequiredMATMaterialDetails/RequiredMATMaterialDetails.html',
    ...
    /**
    * Component controller for Required Material Details
    * @constructor
    * @ngdoc object
    ...
    */
    ComponentController.$inject = ['$rootScope', '$scope', 'common.services.logger.service', 'common.services.component.uiComponentService',
        '$translate', 'Siemens.SimaticIT.UAPI.PICore.commonService', 'common.base', 'Siemens.SimaticIT.UAPI.PICore.WorkOrderService',
    ...
    function ComponentController($rootScope, $scope, loggerService, uiComponentService, $translate,
        commonService, base, workOrderService, WorkOrderOperationService, materialService, messageOverlay, dialogService, $q) {
        var vm = this;
        var logger;
        ...
        function activate() {
            logger = base.services.logger.service.getModuleLogger('requiredmatmaterialdetails');
            exposeApi();
            init();
            initHeaders();
            initTableData();
        ...
        function init() {
            ...
            vm.requiredmatmaterialdetailsComponentTitle = $translate.instant('picore.titles.requiredMaterialDetailsComponentTitle');
            vm.translatedCloseButton = $translate.instant('picore.buttonsAndTooltips.close');
            vm.selectedRequired_Mat_MaterialDetailId = null;
            vm.selectedRequired_Mat_MaterialDetail = null;
            ...
            vm.workOrderOperationrequiredmatmaterialdetailsPropertyGrid = [{
                id: 'NoData',
        ...
        function findAll(serverDataOptions) {
            ...
            backendService.findAll(queryModel).then(function (data) {
                ...
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('edit', vm.showEdit && !vm.isInEditMode && !vm.IsFrozen && !vm.IsLocked);
        ...
        function initHeaders() {
            ...
            vm.requiredmatmaterialdetailsDataConfig = {
                Headers: [
                    {
                        Key: 'MTUNId',
                        DisplayName: $translate.instant('picore.headers.tables.nId'),
                ...
                onPiSelectionChangeCallback: onPirequiredmatmaterialdetailsTableItemSelected
            };

            vm.requiredmatmaterialdetailsToolbarButtons = [
                {
                    icon: 'fa-pencil',
                    cmdIcon: 'Edit',
                    name: 'edit',
                ...
                },
                {
                    ...
                    visibility: vm.selectedRequired_Mat_MaterialDetail && vm.toolbarVisible
                },
                {
                    icon: 'sit sit-assign',
                    cmdIcon: 'Link',
        ...
        function initTableData() {
            vm.requiredmatmaterialdetailsTableFields = {
                'MTUNId': {
                    sorting: true,
                    grouping: false,
                    quicksearch: true,
            ...
            vm.requiredmatmaterialdetailsTableConfig = {
                data: [],
                dataSource: {
                    dataService: internalService,
                    appName: 'PICore',
                    dataEntity: 'MaterialRequirementMTU',
                    optionsString: '$filter=WorkOrderOperationMaterialRequirement_Id eq ' + workOrderOperationMaterialRequirementIdEmpty
                },
                selectionMode: 'single',
                fields: vm.requiredmatmaterialdetailsTableFields,
            ...
            $scope.$watch('vm.workOrderOperationMaterialRequirementId', function (newValue) {
                ...
                if (newValue) {
                    vm.requiredmatmaterialdetailsTableConfig.dataSource.optionsString = '$filter=WorkOrderOperationMaterialRequirement_Id eq '
                        + vm.workOrderOperationMaterialRequirementId;
                    if (vm.requiredmatmaterialdetailsTableConfig.refreshData) {
                        vm.requiredmatmaterialdetailsTableConfig.refreshData();
                    }
                } else {
                    vm.requiredmatmaterialdetailsTableConfig.dataSource.optionsString = '$filter=WorkOrderOperationMaterialRequirement_Id eq '
                        + workOrderOperationMaterialRequirementIdEmpty;
                    if (vm.requiredmatmaterialdetailsTableConfig.refreshData) {
                        vm.requiredmatmaterialdetailsTableConfig.refreshData();
                    }
                }
        ...
        function initDialogData() {
            vm.addLotTemplate = 'Siemens.SimaticIT.UAPI.PICore/components/requiredmatmaterialdetails/add-lot-dialog.html';
            vm.addLotData = {
                'Properties': [
                    {
                        id: 'MaterialNId',
            ...
            vm.addMTUTemplate = 'Siemens.SimaticIT.UAPI.PICore/components/requiredmatmaterialdetails/add-mtu-dialog.html';
            vm.addMTUData = {
        ...
        function resetActionBarVisibility() {
            if (vm.requiredmatmaterialdetailsDataConfig && vm.requiredmatmaterialdetailsDataConfig.setButtonVisible) {
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('edit', vm.showEdit && !vm.IsFrozen && !vm.IsLocked);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('delete', false);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('associateMTU', false);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addLot', !vm.IsFrozen && !vm.IsLocked);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addMTU', !vm.IsFrozen && !vm.IsLocked);
            }
        }

        function onPirequiredmatmaterialdetailsTableItemSelected(list, item) {
            if (item) {
                vm.detailItem = item;
                vm.detailList = list;
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('delete', !vm.isInEditMode && !vm.IsFrozen && !vm.IsLocked);
                if (!item.MTUNId) {
                    vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('associateMTU', !vm.isInEditMode && !vm.IsFrozen && !vm.IsLocked);
                } else {
                    vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('associateMTU', false);
                }
            } else {
        ...
        function onAddMtuOk() {
            ...
            var params = {
                'WorkOrderOperationMaterialRequirementId': vm.workOrderOperationMaterialRequirementId,
                'MTUsToWorkOrderOperationMaterialRequirement': mtuSToAdd
            };
            workOrderService.addMtuToMaterialRequirementV2(params)
        ...
        function onAssociateMtuOk() {
            ...
            if (vm.detailItem) {
                ...
                workOrderService.updateMaterialRequirementMTUV2(params)
        ...
        function onAddLotOk() {
            ...
            var params = {
                'WorkOrderOperationMaterialRequirementId': vm.workOrderOperationMaterialRequirementId,
                'MTUsToWorkOrderOperationMaterialRequirement': lotToAdd
            };
            workOrderService.addMtuToMaterialRequirementV2(params)
            ...
            if (vm.detailItem) {
                vm.overlay = {
                    ...
                    buttons: [{
                        ...
                        onClickCallback: function () {
                            if (vm.detailItem) {
                                workOrderService.deleteMtuFromMaterialRequirement({ Id: vm.detailItem.Id })
        ...
        function onEdit() {
            vm.requiredmatmaterialdetailsDataConfig.setCellEdit();
            vm.isInEditMode = true;
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('edit', false);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('save', !vm.IsFrozen && !vm.IsLocked);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('cancel', !vm.IsFrozen && !vm.IsLocked);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('delete', false);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('associateMTU', false);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addLot', false);
            vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addMTU', false);
        }
        ...
        function onSave() {
            ...
            for (var i = 0; i < vm.dataMTU.length; i++) {
                if (vm.dataMTU[i].MTUNId) {
                    calls.push(workOrderService
                        .updateMaterialRequirementMTUV2({ Id: vm.dataMTU[i].Id, Quantity: vm.dataMTU[i].Quantity.QuantityValue })
                        .catch(exceptionErrorFn));
                }
            }
            $q.all(calls).then(onSetQtysSuccess, onFirstError);
            vm.requiredmatmaterialdetailsDataConfig.deSelect();
        ...
        function onSetQtysSuccess() {
            if (bulkOverlay) {
                ...
                vm.overlay = {
                    text: $translate.instant('picore.notifications.errors.errorBulkMTUMatReq') + ' '
                        + stringFailedReason + '\n' + $translate.instant('picore.notifications.errors.errorBulkMTUMatReqElement') + ' '
                        + stringFailedParams,
                ...
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('save', false);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('cancel', false);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('delete', vm.selectedMTUItem && !vm.IsFrozen && !vm.IsLocked);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addLot', !vm.IsFrozen && !vm.IsLocked);
                vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addMTU', !vm.IsFrozen && !vm.IsLocked);
                vm.isInEditMode = false;
                vm.requiredmatmaterialdetailsDataConfig.setCellReadOnly();
                if (vm.requiredmatmaterialdetailsTableConfig.refreshData) {
                    vm.requiredmatmaterialdetailsTableConfig.refreshData();
                }
            }
            ...
            vm.overlay = {
                ...
                buttons: [{
                    ...
                    onClickCallback: function () {
                        ...
                        vm.isInEditMode = false;
                        vm.requiredmatmaterialdetailsDataConfig.deSelect();
                        if (vm.requiredmatmaterialdetailsDataConfig.refreshData) {
                            vm.requiredmatmaterialdetailsDataConfig.refreshData();
                        }
                        removeOverlay();
                    }
                }, {
    ...
    */
        ...
        function onClose() {
            var eventName = 'requiredmatmaterialdetails.' + vm.name + '.onClose';
        ...
        */
        ...
        function setWorkOrderOperationMaterialRequirementId(workOrderOperationMaterialRequirementId) {
            ...
            if (vm.requiredmatmaterialdetailsDataConfig !== undefined && vm.requiredmatmaterialdetailsDataConfig.deSelect !== undefined) {
                vm.requiredmatmaterialdetailsDataConfig.deSelect();
            }
            if (vm.workOrderOperationMaterialRequirementId) {
        ...
        function getContextInfo(workOrderOperationMaterialRequirementId) {
            commonService.findAll({
                ...
                options: '$filter=Id eq ' + workOrderOperationMaterialRequirementId + '&$expand=WorkOrderOperation($expand=WorkOrder,'
                    ...
                    + 'Facets($select=Siemens.SimaticIT.UAPI.PICore.PICore.PIPOMModel.DataModel.ReadingModel.WorkOrderOperationMaterialRequirementExtended/BoMNId,'
                ...
                if (result !== undefined && result !== null && result.value !== undefined && result.value !== null) {
                    ...
                    vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addLot', !vm.IsFrozen && !vm.IsLocked);
                    vm.requiredmatmaterialdetailsDataConfig.setVisibilityByActionName('addMTU', !vm.IsFrozen && !vm.IsLocked);
                    vm.equipmentGraphNId = result.value[0].Facets[0].EquipmentGraphNId;
                    vm.materialRequirementEquipmentNId = result.value[0].Facets[0].EquipmentNId;
                    vm.workOrderOperationActualEquipment = result.value[0].WorkOrderOperation.Facets[0].ActualEquipmentNId;
                    vm.requirementTag = result.value[0].Facets[0].RequirementTag;
       ...
       */
        ...
        */
        ...
        function setContextDetails() {
            vm.NoData = false;
            vm.workOrderOperationrequiredmatmaterialdetailsPropertyGridData = [
                {
                    id: 'WorkOrder',
                ...
                {
                    id: 'RequirementTag',
                    label: $translate.instant('picore.headers.propertyGrids.requirementTag'),
                    read_only: true,
                    widget: 'sit-label',
                    value: vm.requirementTag,
                    validation: {}
                }
            ];
        }
