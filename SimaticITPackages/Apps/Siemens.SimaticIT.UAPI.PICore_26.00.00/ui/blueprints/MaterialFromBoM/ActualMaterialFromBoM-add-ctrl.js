(function () {
    ...
    function AddActualMaterialFromBoMController($q, $timeout, $translate, $state, $stateParams, $rootScope, $scope, common, modelDrivenService) {
        const self = this;
        ...
        function buildActualMaterials() {
            ...
            for (const idx in self.gridBomItemSelectedItems) {
                ...
                const obj = {
                    ...
                    Quantity: { QuantityValue: item.Quantity.QuantityValue, UoMNId: item.Quantity.UoMNId },
        ...
        function addMaterialsFromBoM() {
            console.log('PICore_AddActualMaterialFromBoMController.addMaterialsFromBoM');

            const obj = {
                WorkOrderOperationId: $stateParams.selectedItem.Id,
                WorkOrderOperationActualMaterials: buildActualMaterials()
            };

            executeCommand('PICore', 'AddWorkOrderOperationActualMaterialsToWorkOrderOperation', obj).then(function (data) {
                ...
                if (typeof self.onActionComplete === 'function') {
                    ...
                    self.onActionComplete(data.data.WorkOrderOperationActualMaterialIds[0]);
                }
        ...
        function initSidePanel() {
            console.log('PICore_AddActualMaterialFromBoMController.initSidePanel');
            const cancel = {
        ...
        function init() {
            console.log('PICore_AddActualMaterialFromBoMController.init');
        ...
        function activate() {
            console.log('PICore_AddActualMaterialFromBoMController.activate');
    ...
    angular.
        ...
        controller('PICore_AddActualMaterialFromBoMController', AddActualMaterialFromBoMController).
        config([
            '$stateProvider',
            function ($stateProvider) {

                const rootstate = 'home.Siemens_SimaticIT_UAPI_PICore_WorkOrderConfiguration_WorkOrderOperationContent.AddFromBoM2';
                ...
                const item = {
                    ...
                    views: {
                        'property-area-container@': {
                            templateUrl: folder + '/ActualMaterialFromBoM-add.html',
                            controller: 'PICore_AddActualMaterialFromBoMController',
                            controllerAs: 'vm'
                        }
                    }
                };
    ...
    AddActualMaterialFromBoMController.$inject = ['$q', '$timeout', '$translate', '$state', '$stateParams', '$rootScope', '$scope', 'common.base', 'common.services.modelDriven.runtimeService'];
}());