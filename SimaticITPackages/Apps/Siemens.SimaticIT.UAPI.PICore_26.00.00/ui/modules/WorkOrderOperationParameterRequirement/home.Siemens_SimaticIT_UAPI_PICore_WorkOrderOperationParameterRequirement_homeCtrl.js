(function () {
    'use strict';
    angular.module('Siemens.SimaticIT.UAPI.PICore.WorkOrderOperationParameterRequirement').controller('Siemens_SimaticIT_UAPI_PICore_WorkOrderOperationParameterRequirement_homeController', Controller);
	...
	function Controller($scope) {
		...
		function init() {
			...
			vm.componentInstances.push({
				name: 'home_workorderoperationparamlist_2',
				layout: {
					row: 0,
					col: 0,
					sizeX: 12,
				...
				contracts: {
					methods: ['setWorkOrderOperationId','setActionBarVisibility'],
					events: [],
  ...
  30,
  50
]},PageSizeDefault: {node:'data',type:'Number',category:'Visibility',description:'',permission:'rw',default: 5},IsTitleVisible: {node:'data',type:'Boolean',category:'Visibility',description:'',permission:'rw',default: True}}
				},
				isVisible: true
			});
