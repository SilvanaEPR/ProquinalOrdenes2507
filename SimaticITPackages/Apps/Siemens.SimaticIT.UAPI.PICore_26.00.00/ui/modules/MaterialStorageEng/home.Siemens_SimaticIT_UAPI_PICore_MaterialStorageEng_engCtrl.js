...
angular.module('Siemens.SimaticIT.UAPI.PICore.MaterialStorageEng')
    .controller('home.Siemens_SimaticIT_UAPI_PICore_MaterialStorageEng_engController', ['$scope', function ($scope) {
        ...
        vm.componentInstances = [
            ...
            {
                'name': 'eng_storagehierarchylist_2',
                'layout': {
                    'row': 0,
                    'col': 0,
                    'sizeX': 6,
            ...
            {
                'name': 'eng_storagehierarchydetails_5',
                'layout': {
                    'row': 0,
                    'col': 6,
                    'sizeX': 6,
        ...
        function converters(vm) {
            vm.onSelectionChangeConverter = {
                'eng_storagehierarchydetails_5': function (input) {
                    var evtObj = input[0];
                    var result = [];
