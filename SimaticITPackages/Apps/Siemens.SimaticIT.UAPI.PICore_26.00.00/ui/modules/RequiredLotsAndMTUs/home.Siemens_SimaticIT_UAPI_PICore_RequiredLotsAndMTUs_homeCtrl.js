(function () {
    'use strict';
	angular.module('Siemens.SimaticIT.UAPI.PICore.RequiredLotsAndMTUs').controller('Siemens_SimaticIT_UAPI_PICore_RequiredLotsAndMTUs_homeController', Controller);
	...
	function Controller($scope) {
		...
		function init() {
			...
			vm.componentInstances.push({
				name: 'home_requiredmatmaterialdetails_2',
				layout: {
					row: 0,
					col: 0,
					sizeX: 12,
            ...
            vm.DisableCloseButtonConverter = {
                'home_requiredmatmaterialdetails_2': function (input) {
                    var evtObj = input[0];
                    var result = [];
