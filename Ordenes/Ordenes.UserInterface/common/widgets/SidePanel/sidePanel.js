...
(function () {
    ...
    */
    ...
    SidepanelController.$inject = ['common', '$translate', '$element', '$timeout', '$scope', 'common.base','CONFIG'];
    function SidepanelController(common, $translate, $element, $timeout, $scope, base,CONFIG) {
        var vm = this;
        ...
        function init() {
            //This is a sidepanel feature to overwrite the configuration has been done in solution studio
            // if sidepanel settings is enabled in solution studio then will check for the sidePanelautoclose properties
            if (CONFIG.sidePanel && CONFIG.sidePanel.enabled === true) {
                if (CONFIG.sidePanel.autoClose === true) {
                    vm.sidePanelAutoClose = 'true';
                }
                else {
                    vm.sidePanelAutoClose = 'false';
                }
            }
        ...
        function getActiveActionButtons() {
            return _.filter(vm.actionButtons.slice(), function (item) { return item.visible });
        }
