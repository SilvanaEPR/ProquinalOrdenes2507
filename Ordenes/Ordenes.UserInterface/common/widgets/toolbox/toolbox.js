...
(function () {
    ...
    * * **full**: the size of the toolbox will be 100% of the screen.
    *
    ...
    */
    ...
    function ToolboxController($element) {
        ...
        function initAPI() {
            ...
            vm.config.expandFull = expandFull;
        ...
        * @access internal
        * @module siemens.simaticit.common.widgets.toolbox
        * @name toolboxOptions#expandFull
        *
        * @description
        * An API method which expands the tollbox to full size.
        *
        */
        function expandFull() {
            vm.size = "full";
