                ...
                (function (notificationTile) {
                    ...
                    */
                    var GlobalNotificationService = /** @class */ (function () {
                        function GlobalNotificationService($translate, notificationTileService, swacUiModuleManager, $sanitize) {
                            var _this = this;
                            ...
                            this.debouncedInfo = _.debounce(function (message) {
                                _this.infoTileOptions.content = message ? message : _this.tileOptions.content;
                                _this.infoTileOptions.type = 'info';
                                _this.infoTileOptions.title = _this.tileOptions.title ? _this.tileOptions.title : _this.$translate.instant('Notification.infoTitle');
                                if (_this.swacUiModuleManager.enabled) {
                                    _this.swacUiModuleManager.notificationServicePromise.promise.then(function (service) {
                                        service.show(_this.$sanitize(_this.infoTileOptions.title), _this.$sanitize(_this.infoTileOptions.content), { notifyType: _this.infoTileOptions.type });
                                    });
                                }
                                else {
                                    _this.showNotification(_this.infoTileOptions);
                                }
                            }, 300, true);
                            this.debouncedWarn = _.debounce(function (message) {
                                _this.warnTileOptions.content = message ? message : _this.tileOptions.content;
                                _this.warnTileOptions.type = 'warning';
                                _this.warnTileOptions.title = _this.tileOptions.title ? _this.tileOptions.title : _this.$translate.instant('Notification.warningTitle');
                                if (_this.swacUiModuleManager.enabled) {
                                    _this.swacUiModuleManager.warningServicePromise.promise.then(function (service) {
                                        service.show(_this.$sanitize(_this.warnTileOptions.title), _this.$sanitize(_this.warnTileOptions.content), { notifyType: _this.warnTileOptions.type });
                                    });
                                }
                                else {
                                    _this.showNotification(_this.warnTileOptions);
                                }
                            }, 300, true);
                            this.tileOptions = this.defaults;
                            this.infoTileOptions = this.infoDefaults;
                            this.warnTileOptions = this.warnDefaults;
                        }
                        /**
                        * @ngdoc method
                       ...
                       */
                        ...
                        GlobalNotificationService.prototype.showNotification = function (tileOptions) {
                            this.configCallback.forEach(function (fnCallback) {
                                fnCallback(tileOptions);
                            });
                        ...
                        GlobalNotificationService.$inject = ['$translate', 'common.widgets.notificationTile.service', 'common.services.swac.SwacUiModuleManager', '$sanitize'];
