...
(function () {
     ...
     *  @param {string} [sit-group-name=""] name to be used to group components under the container.
     *
     * @example
    ...
    function ContainerDirective(swacContainerService, uiComponentService, $window, $location, $timeout, logger, umcService) {
        ...
        function compile(element, attributes) {
            var isSwac = false, isMashupRuntime = false;
            var timer, componentsCount, onContainerResize;
            if (!validateAttributes()) {
                return undefined;
            }
            componentsCount = element.find('sit-component').length;
            isSwac = attributes.sitIsswac;
            isMashupRuntime = attributes.sitIsMashupRuntime;
            if (isSwac) {
            ...
            function validateAttributes() {
                ...
                var ismashupruntime = angular.$$lowercase(attributes.sitIsMashupRuntime);
                ...
                attributes.sitIsMashupRuntime = ('true' === ismashupruntime);
                return true;
            }

            function pre($scope, element, attributes, controller) {
                controller.isSwac = isSwac;
                controller.containerPrefix = '';
            ...
            function post($scope, element, attributes, controller) {
