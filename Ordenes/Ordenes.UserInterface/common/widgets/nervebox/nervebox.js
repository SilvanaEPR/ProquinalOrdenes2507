...
(function () {
    ...
    */
    ...
    NerveboxService.$inject = [
        '$interval',
        '$translate',
        '$rootScope',
        '$q',
        '$log',
        'common.services.nerveBoxDataService',
        'common.ctx'
    ];
    function NerveboxService($interval, $translate, $rootScope, $q, $log, nerveBoxDataService, commonContext) {
        var id = 'nerve-box';
        var _that = this;
        ...
        this.show = function () {
            // is the application exposing an UI Component as swac component?
            // If yes, Not required to show nervebox
            if (commonContext.isSwacEnabled() && 'component' === commonContext.getSwacType()) {
                return;
            }
        ...
        this.interval = function (callback, ticks, name) {
            ...
            function start(runOnce) {
                if (!intervalPromise) {
                    intervalPromise = $interval(callback, ticks, 0, false);
                    runOnce && callback();
                }
    ...
    function NerveboxStartupService($rootScope) {
        ...
        this.stop = function () {
            ...
            nerveBoxStatus = false;
        };
        this.isStarted = function () {
            return nerveBoxStatus;
        }
    }
})();
