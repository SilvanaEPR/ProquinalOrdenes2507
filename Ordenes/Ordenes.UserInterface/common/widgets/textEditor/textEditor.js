    ...
    function TextEditorController($rootScope, $scope, $window, $timeout, $translate, editorService, globalDialogService, swacManager) {
        ...
        var timer = $timeout(function () {
            $window.CKEDITOR.replace(vm.id, {
                ...
                disallowedContent: 'iframe script; *[on*]; *[class]; span{font,font-size,font-family}',
                extraAllowedContent: 'img{width}[src,alt,style]',
                extraPlugins: 'placeholder,imageDragResize,imageUpload,colorbutton,justify',
                removePlugins: 'image, pagebreak, print, exportpdf, liststyle, print, smiley, copyformatting, div',
                qtCellPadding: '0',
                qtCellSpacing: '0',
                toolbarGroups: [
                ...
                removeButtons: 'Underline,Subscript,Superscript,BGColor,Styles,JustifyBlock,Unlink,Anchor,SpecialChar,HorizontalRule, div',
    ...
    function TextEditorService(globalizationService, $textEditorSanitize) {
        ...
        */
        function getEditorContent(id) {
            ...
            return data.safeReplaceAll(addTarget, '<a target=\"_blank\" href');
        }
