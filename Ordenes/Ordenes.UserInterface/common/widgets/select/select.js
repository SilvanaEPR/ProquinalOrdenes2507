...
(function () {
    ...
    *       ng-readonly="ngReadonly" ng-blur="ngBlur" sit-always-on-top = "true" sit-change="sitChange" ng-disabled="ngDisabled" ng-focus="ngFocus">
    * </sit-select>
    * ```
    * @restrict E
	*
    ...
    * @param {boolean} [sit-always-on-top=false] _(Optional)_  Attribute to enable the select dropdown items to
    *    be visible without an additional scrollbar in case of fixed parent height.
    ...
    * @param {string} [sit-dropdown-mode] _(Optional)_ Enables the sit-text-select widget when it is defined as **comboBox**, otherwise enables the sit-advanced-select widget.
    *
    * @example
    ...
    */
    ...
    function SelectController(scope) {
        ...
        function init() {
            ...
            vm.placeholder = vm.sitPlaceholder ? vm.sitPlaceholder : '';
        ...
        function validityChangeCallback(value, ngModel) {
            ...
            vm.validation.custom(value, ngModel, vm.toKeep);
        }
