        ...
        var BusyIndicatorService = /** @class */ (function () {
            ...
            */
            BusyIndicatorService.prototype.show = function (data) {
                ...
                if (this.swacUiModuleManager.enabled) {
                    if (this.swacService) {
                        this.automaticRefesh(data);
                    }
                    else {
                        this.swacUiModuleManager.busyServicePromise.promise.then(function (service) {
                            _this.swacService = service;
                            _this.automaticRefesh(data);
                        });
                    }
                }
                else {
            ...
            BusyIndicatorService.prototype.automaticRefesh = function (data) {
                if (data !== undefined && data.message !== undefined) {
                    this.swacService.show(data.message);
                }
                else {
                    this.swacService.show();
                }
            };
            /**
            * @ngdoc method
            ...
            */
            BusyIndicatorService.prototype.hide = function () {
                var _this = this;
                if (this.busyIndicatorCount > 1) {
                    this.busyIndicatorCount--;
                    return;
                }
                if (this.swacUiModuleManager.enabled) {
                    if (this.swacService) {
                        this.swacService.hide();
                    }
                    else {
                        this.swacUiModuleManager.busyServicePromise.promise.then(function (service) {
                            _this.swacService = service;
                            _this.swacService.hide();
                        });
                    }
                }
                else {
