...
(function () {
    ...
    * @param {Object} [show-meridian] _(Optional)_ An attribute sit-show-meridian which specifies whether to display 12H or 24H mode. True is 12H mode. (Default: true)
    * @example
    ...
    app.directive('sitTimePicker', ['$document', function ($document) {
        return {
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                ctrl.id = 'id' + new Date().getTime();
                function documentClickBind(event) {
                    if (ctrl.isOpen && !$(event.target).parents("#" + ctrl.id).length) {
