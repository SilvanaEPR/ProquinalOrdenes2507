...
(function () {
    ...
    function ComponentController(
        ...
        function activate() {
            ...
            // Set SWAC Type to Component
            commonCtx.setSwacType('component');
        ...
        function onExposeSuccess() {
            ...
            // Setting the flag in the Common context to block navigation for SWAC component loaded from Manifest
            commonCtx.setNavigationBlocked(true);
        }
