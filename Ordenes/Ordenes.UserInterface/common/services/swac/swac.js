...
(function (sit) {
    ...
    (function (framework) {
        var SwacUiModuleManager = /** @class */ (function () {
            function SwacUiModuleManager($window, $injector, $timeout, $rootScope, $log, $q, authentication, swacComponentService, context) {
                var _this = this;
                this.$window = $window;
            ...
            SwacUiModuleManager.prototype.initSwac = function ($window, $log) {
                ...
                this.themeServicePromise = this.context.themeServicePromise;
                this.busyServicePromise = this.context.busyServicePromise;
                //this.nerveboxServicePromise = this.$q.defer();
                this.confirmationServicePromise = this.context.confirmationServicePromise;
                this.errorServicePromise = this.context.errorServicePromise;
                this.warningServicePromise = this.context.warningServicePromise;
                this.i18NServicePromise = this.context.i18NServicePromise;
                this.navigationServicePromise = this.context.navigationServicePromise;
                this.notificationServicePromise = this.context.notificationServicePromise;
                this.contextServicePromise = this.context.contextServicePromise;
                this.eventBusServicePromise = this.context.eventBusServicePromise;
                this.displayServicePromise = this.context.displayServicePromise;
            ...
            SwacUiModuleManager.prototype.init = function () {
                this.enabled = this.context.isSwacEnabled();
            ...
            SwacUiModuleManager.prototype.exposeComponent = function () {
                ...
                this.startComponent().then(function () {
                    ...
                    that.SWAC.Config.TimeOuts.Internal = 10000;
                    swacHub.beginExpose().then(function () {
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Busy').then(function (value) {
                            that.busyServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Display').then(function (value) {
                            that.displayServicePromise.resolve(value);
                            framework.SWACServiceManager.addService('MOM.UI.Display', value); //replace service with the parent one
                        }, function (error) {
                            that.displayServicePromise.reject(error);
                        }));
                        //servicesRequestPromises.push(swacHub.services.beginGet('sit.Nervebox').then((value) => {
                        //    that.nerveboxServicePromise.resolve(value);
                        ...
                        //    if (parS) {
                        //        that.nerveboxServicePromise.resolve(parS);
                        //    } else {
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Confirmation').then(function (value) {
                            that.confirmationServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Context').then(function (value) {
                            that.contextServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.EventBus').then(function (value) {
                            that.eventBusServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Error').then(function (value) {
                            that.errorServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Warning').then(function (value) {
                            that.warningServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.I18n').then(function (value) {
                            that.i18NServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Navigation').then(function (value) {
                            that.navigationServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Notification').then(function (value) {
                            that.notificationServicePromise.resolve(value);
                        ...
                        servicesRequestPromises.push(swacHub.services.beginGet('MOM.UI.Theme').then(function (value) {
                            that.themeServicePromise.resolve(value);
                        ...
                        var promise = SWAC.Promise || window.Promise;
                        promise.all(servicesRequestPromises).then(function () {
                            return that.registerServices();
                        }, function () { return that.registerServices(); }); //final service registration
                        deferr.resolve();
                    }, function (error) {
                        that.$log.error('swacHub failed to expose component: ' + that.swacComponent.name + ',reasonCode:' + error.reasonCode + ', reason:' + error.message);
                    ...
                    interface: {
                        interfaces: {
                            ...
                            'MOM.UI.Navigable': {
                                ...
                                navigateToState: function (state, stateParams) {
                                    if ('' === state) {
                                        state = 'home';
                                    }
                                    var promiseResult = new SWAC.Defer();
                                    var _$state = _this.$injector.get('$state');
                                    _$state.go(state, stateParams, { inherit: false });
                                    promiseResult.fulfill();
                                },
            ...
            SwacUiModuleManager.prototype.assignDefaultCallbacks = function () {
                this.context.themeServicePromise.promise.then(function () { }).catch(function () { });
                this.context.busyServicePromise.promise.then(function () { }).catch(function () { });
                this.context.confirmationServicePromise.promise.then(function () { }).catch(function () { });
                this.context.errorServicePromise.promise.then(function () { }).catch(function () { });
                this.context.warningServicePromise.promise.then(function () { }).catch(function () { });
                this.context.i18NServicePromise.promise.then(function () { }).catch(function () { });
                this.context.navigationServicePromise.promise.then(function () { }).catch(function () { });
                this.context.notificationServicePromise.promise.then(function () { }).catch(function () { });
                this.context.contextServicePromise.promise.then(function () { }).catch(function () { });
                this.context.eventBusServicePromise.promise.then(function () { }).catch(function () { });
                this.context.displayServicePromise.promise.then(function () { }).catch(function () { });
            };
            SwacUiModuleManager.$inject = [
                '$window',
                '$injector',
                '$timeout',
                '$rootScope',
