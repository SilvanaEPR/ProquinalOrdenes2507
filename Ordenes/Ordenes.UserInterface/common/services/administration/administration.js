        ...
        */
        ...
        function AdministrationDataService(administrationConfig, $injector, $translate, $q, common, CommandResponse, ExecutionError, logger) {
            ...
            function transformGetIdentityClaimsData(data) {
                ...
                var jsonData = plant && plant.NId ? { "Category": data.category, "PlantId": plant.NId }
                ...
                if (data) {
                    try {
                        ...
                        if (Jsondata.Error) {
                            ...
                            if (Jsondata.UIApplicationsPerPlant) {
                                res.UIApplicationsPerPlant = Jsondata.UIApplicationsPerPlant;
                            }
                        }
                        else {
