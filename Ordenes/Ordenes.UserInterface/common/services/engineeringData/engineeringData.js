...
(function (sit) {
    ...
    (function (framework) {
        (function () {
            ...
            engineeringCommands.$inject = ['$q', '$resource', '$http', '$translate', 'common', 'CommandResponse', 'ExecutionError', 'common.services.engineering.DataConfig', 'common.services.plant.plantService'];
            function engineeringCommands($q, $resource, $http, $translate, common, CommandResponse, ExecutionError, engineeringDataConfig, plantService) {
                ...
                function getCmd(path) {
                    ...
                    //This is useful when the engineering service is called by a runtime UI Application
                    var params = {};
                    if (plantService && plantService.plantInfo && plantService.plantInfo.NId) {
                        params = { "plantInfo": plantService.plantInfo.NId };
                    }
