...
(function (sit) {
    ...
    (function (framework) {
        ...
        var PersonalizationService = /** @class */ (function () {
            function PersonalizationService($http, $resource, $q, CONFIG, $state, authService, dataConfig, CommandResponse, ExecutionError, common, dataService, commandService) {
                var _this = this;
            ...
            */
            PersonalizationService.prototype.setPersonalization = function (type, prefrenceId, value) {
                ...
                var payload = {
                    ...
                    commandName: this.SET_PREFERENCE_COMMAND,
                    params: {
                ...
                this.commandService.invoke(payload).then(function (response) {
                    _this.updatePreference(payload.params);
            ...
            */
            PersonalizationService.prototype.resetPersonalization = function (type, prefrenceId) {
                ...
                var payload = {
                    appName: this.SYSTEM_APP,
                    commandName: this.RESET_PREFERENCE_COMMAND,
                    params: {
                        Application: screenInfo.uiapplication,
                        Module: screenInfo.uimodule,
                        Screen: screenInfo.uiscreen,
            ...
            */
            ...
            PersonalizationService.$inject = ['$http', '$resource', '$q', 'CONFIG', '$state', 'common.services.authentication', 'common.services.runtime.DataConfig', 'CommandResponse', 'ExecutionError', 'common', 'common.services.runtime.dataService', 'common.services.runtime.commandService'];
