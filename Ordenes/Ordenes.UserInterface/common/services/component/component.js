...
(function (sit) {
    ...
    (function (framework) {
        ...
        var SwacComponentManager = /** @class */ (function () {
            function SwacComponentManager($window, $log, $q, authentication, uiComponentService, swacComponentService, $rootScope, context) {
                var _this = this;
                this.$window = $window;
                this.$log = $log;
                this.$q = $q;
            ...
            SwacComponentManager.prototype.registerServices = function () {
            ...
            SwacComponentManager.prototype.assignDefaultCallbacks = function () {
