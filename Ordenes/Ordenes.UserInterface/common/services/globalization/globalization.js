...
(function () {
    ...
    */
    ...
    angular.module('siemens.simaticit.common.services.globalization').constant('common.services.widgetConfiguration', {
        dateTimePicker: {
            locale: null
        }
    });
...
(function () {
    ...
    angular.module('siemens.simaticit.common.services.globalization').provider('common.services.globalization.runtimelocale', function () {
        ...
        function loadLocaleScript($rootScope, $q, $timeout, $locale, $interpolate, localeId, localeUrl, localeCache, storage, storeKey, commonContext,BUILDNUMBER) {

            var cachedLocale;
            var deferred = $q.defer();
            var promiseCache = {};
            var activeLocale;
            localeUrl = localeUrl + '?b=' + BUILDNUMBER;
            ...
            function onLocaleNotFound() {
                var url = 'common/scripts/i18n/angular-locale_{{locale}}.js?b=' + BUILDNUMBER;
                var contextType = commonContext.getAppType();
                if (contextType == 'runtime') {
                    url = 'locales/angular-locale_{{locale}}.js?b=' + BUILDNUMBER;
                }
        ...
        this.$get = ['$rootScope', '$injector', '$interpolate', '$locale', '$q', '$timeout', 'common.services.globalization.runtimelocaleStorageCache', 'CONFIG', 'common.ctx','BUILDNUMBER',
            function ($rootScope, $injector, $interpolate, $locale, $q, $timeout, runtimelocaleStorageCache, CONFIG, commonContext, BUILDNUMBER) {
                var LOCALELOCATIONPATH = 'common/scripts/i18n/angular-locale_{{locale}}.js';
                var STOREKEY = 'runtimelocale.locale';
                var contextType = commonContext.getAppType();
                if (contextType === 'runtime') {
                    LOCALELOCATIONPATH = "locales/angular-locale_{{locale}}.js";
                }
