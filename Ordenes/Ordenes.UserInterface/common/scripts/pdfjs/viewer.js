 ...
 * (Current view, Open file and outline options in sidebar were removed)
 */
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function configure(PDFJS) {
                ...
                PDFJS.cMapUrl = './cmaps/';//updated the reference to local cmaps path
            ...
            var PDFViewerApplication = {
                ...
                close: function close() {
                    ...
                    var webviewerUnloadEvent = document.createEvent('Event');
                    webviewerUnloadEvent.initEvent('pinchzoomwebviewerunloaded', true, true);
                    document.dispatchEvent(webviewerUnloadEvent);
                    return promise;
                },
                ...
                performPrint: function performPrint() {
                    ...
                    return new Promise(function (resolve) {
                        setTimeout(function () {
                            ...
                            if (safariAgent) {
                                window.addEventListener('custom-afterprint', customAfterprint, false);
                                function customAfterprint() {
                                    window.removeEventListener('custom-afterprint', customAfterprint, false);
            ...
            if ('onbeforeprint' in window) {
                var stopPropagationIfNeeded = function stopPropagationIfNeeded(event) {
                    if (event.type === 'afterprint') {
                        window.dispatchEvent(new CustomEvent('custom-afterprint'));
                    }
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function webViewerLoad() {
                ...
                var webviewerloadedEvent;
                webviewerloadedEvent = document.createEvent('Event');
                webviewerloadedEvent.initEvent('pinchzoomwebviewerloaded', true, true);
                document.dispatchEvent(webviewerloadedEvent);
            }
