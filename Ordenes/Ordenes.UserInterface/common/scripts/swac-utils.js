            ...
            */
            function _switchMethodsFunctions(manifest, config) {
                ...
                if (typeof config === 'object' && typeof config.useFunctions === 'boolean' && config.useFunctions) {
                    ...
                    if (manifest.interfaces && Object.getOwnPropertyNames(manifest.interfaces).length > 0) {
            ...
            */
            ...
            retObj.versions.push({
                ...
                fromPrevious: function (m, config) {
                    ...
                    // optional field
                    if (m.flavor) {
                        if (m.flavor.toLowerCase() === 'ui' || m.flavor.toLowerCase() === 'uiless' || m.flavor.toLowerCase() === 'webworker') {
                    ...
                    if (m.prerequisites) {
                        ...
                        if (m.prerequisites.renderingSpace) {
                            if (typeof m.prerequisites.renderingSpace === 'object') {
                                ...
                                // check unknow field
                                if (Object.getOwnPropertyNames(m.prerequisites.renderingSpace).length === 0) { // no custom content
                                    delete m.prerequisites.renderingSpace;
                                }
                            }
                        }
                        if (Object.getOwnPropertyNames(m.prerequisites).length === 0) { // no custom content
                    ...
                    if (m.homepage || m.author || m.keywords || m.description) {
                        ...
                        if (typeof m.author === 'object') {
                            ...
                            if (Object.getOwnPropertyNames(m.author).length === 0) { // no custom content
                                delete m.author;
                            }
                        }
                    }
                    ...
                    if (m.API || m.interfaces || (m.DPC && m.DPC.length > 0)) {
                        ...
                        if (typeof m.API === 'object') {
                            ...
                            if (Object.getOwnPropertyNames(m.API).length === 0) { // no custom content
                                delete m.API;
                            }
                        }
                        if (typeof m.interfaces === 'object') {
                            ...
                            for (var propName in m.interfaces) {
                                if (m.interfaces.hasOwnProperty(propName)) {
                                    ...
                                    if (Object.getOwnPropertyNames(m.interfaces[propName]).length === 0) { // no custom content
                                        delete m.interfaces[propName];
                                    }
                                }

                            }
                            if (Object.getOwnPropertyNames(m.interfaces).length === 0) { // no custom content
                                delete m.interfaces;
                            }
                        }
                        if (m.DPC) {
                    ...
                    if (Object.getOwnPropertyNames(m).length > 0) { // no custom content
                ...
                toPrevious: function (m, config) {
                    ...
                    if (m.identity.flavor && (m.identity.flavor.toLowerCase() === 'ui' || m.identity.flavor.toLowerCase() === 'uiless' || m.identity.flavor.toLowerCase() === 'webworker')) {
        ...
        if ((typeof module !== 'undefined') && (typeof module.exports !== 'undefined')) {
            ...
            if ((checkSystemJs && SystemJS.map.hasOwnProperty('@swac/base')) ||
                ...
                define('@swac/utils', ['@swac/base'], function (base) {
                    if (base && typeof base.prototype.Utils !== 'object') {
